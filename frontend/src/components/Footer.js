        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <a 
                  href="https://github.com/siddharthksah/deepfake" 
                  target="_blank" 
                ...
                <a 
                  href="mailto:deepfake.hq@gmail.com"
                  className="text-neutral-400 hover:text-primary-400 transition-colors duration-200"
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a 
                    href="mailto:deepfake.hq@gmail.com?subject=DeepFake Enterprise Inquiry"
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-neutral-500">
                DeepFake is continuously improving. Report issues on our GitHub repository.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-neutral-700/50 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="text-sm text-neutral-500">
              © {currentYear} DeepFake. All rights reserved.
            </div>
