...
start:
	@echo "Starting DeepFake..."
	docker compose up -d
	@echo "DeepFake is running at http://localhost:8888"

stop:
	@echo "Stopping DeepFake..."
	docker compose down
...
test:
	...
	docker cp test_system.py deepfake-api:/app/
	docker cp test_samples deepfake-api:/app/
	docker exec deepfake-api python test_system.py
