#!/usr/bin/env python3
"""
DeepFake Meta-Feature Generator
===============================
...
# Ensure deepfake_utils is importable regardless of execution context.
...
try:
    ...
    try:
        ...
        print(f"Critical Error: Failed to resolve deepfake_utils dependency. {e}")
        sys.exit(1)
...
def main():
    parser = argparse.ArgumentParser(
        description="DeepFake Meta-Feature Generator: ETL for Stacking Ensemble Training Data.",
