...
## Overview
This directory contains the integration of the **Vocoder Artifacts** audio deepfake detection model into DeepFake.
...
python deepfake_test.py test --media-type audio --input test_samples/sample_audio.wav
```
